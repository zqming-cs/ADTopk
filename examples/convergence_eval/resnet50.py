...
parser.add_argument('--log-dir', default='./save_model/cifar100_resnet50/logs',
                    help='tensorboard log directory')
parser.add_argument('--checkpoint-format', default='./save_model/cifar100_resnet50/checkpoint-{epoch}.pth.tar',
...
if __name__ == '__main__':
    ...
    if hvd.rank() == 0:         
        ...
        np.savetxt("./data/r50_005.txt", ans)         