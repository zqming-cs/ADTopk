...
def calculation_backward_time_local_8_nodes(sum_numel, numel, net_name):
    if net_name=='resnet50':
        ...
        # VGG-16
        backward_time= 0.015516927047648
    elif net_name=='vgg19':
        # VGG-19
        backward_time= 0.0176436596987194
    
    elif net_name=='lstm':
        # LSTM-wikitext-2
        backward_time= 0.06509669449
    elif net_name=='transformer':
        # Transformer -wikitext-2 
        backward_time= 0.0935338914394378
    elif net_name=='bert_base':
        # BERT
        backward_time= 0.04641398668289
    else:
        backward_time= 0.0
...
gradient_size_array_resnet152 = [100, 204800, 2048, 2048, 1048576, 512, 512, 2359296, 512, 512, 1048576, 2048, 2048, 1048576, 512, 512, 2359296, 512, 512, 1048576, 2048, 2048, 2097152, 2048, 2048, 1048576, 512, 512, 2359296, 512, 512, 524288, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 262144, 1024, 1024, 524288, 1024, 1024, 262144, 256, 256, 589824, 256, 256, 131072, 512, 512, 65536, 128, 128, 147456, 128, 128, 65536, 512, 512, 65536, 128, 128, 147456, 128, 128, 65536, 512, 512, 65536, 128, 128, 147456, 128, 128, 65536, 512, 512, 131072, 512, 512, 65536, 128, 128, 147456, 128, 128, 32768, 256, 256, 16384, 64, 64, 36864, 64, 64, 16384, 256, 256, 16384, 64, 64, 36864, 64, 64, 16384, 256, 256, 16384, 256, 256, 16384, 64, 64, 36864, 64, 64, 4096, 64, 64, 1728]

gradient_size_array_lstm_wiki2 = [33278, 16639000, 2000, 2000, 1000000, 1000000, 2000, 2000, 1000000, 1000000, 16639000]

# wikitext-103
gradient_size_array_transformer_wiki103 = [267735, 107094000, 107094000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000]
# wikitext-2
gradient_size_array_transformer_wiki2 = [33278, 13311200, 13311200, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000, 400, 400, 400, 400, 400, 160000, 400, 160000, 400, 160000, 1200, 480000]

gradient_size_array_vgg16 = [100, 409600, 4096, 16777216, 4096, 2097152, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 1179648, 256, 256, 256, 589824, 256, 256, 256, 589824, 256, 256, 256, 294912, 128, 128, 128, 147456, 128, 128, 128, 73728, 64, 64, 64, 36864, 64, 64, 64, 1728]

gradient_size_array_vgg19 = [100, 409600, 4096, 16777216, 4096, 2097152, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 2359296, 512, 512, 512, 1179648, 256, 256, 256, 589824, 256, 256, 256, 589824, 256, 256, 256, 589824, 256, 256, 256, 294912, 128, 128, 128, 147456, 128, 128, 128, 73728, 64, 64, 64, 36864, 64, 64, 64, 1728]
...
def optimal_gradient_merging_0101(gradient_size_array, net_name, density = 0.1):
    ...
    for i, g in enumerate(groups_new):
        ...
        if density<1 and i>1 and g<= groups_new_[-1]:
        # if density<1 and i>0 and g<= groups_new_[-1]:
            print(g)
            print(groups_new_)
            last_min_group_len = len_gradient_size - sum(groups_new_)
            if last_min_group_len <= groups_new_[-1]:
                groups_new_.append(last_min_group_len)
                break
            else:
                
                while last_min_group_len> sum(groups_new_) :
                    if groups_new_[-1]<3:
                        groups_new_.append(last_min_group_len//3)
                    groups_new_.append(groups_new_[-1])
                    last_min_group_len = len_gradient_size - sum(groups_new_) 
                groups_new_.append(last_min_group_len)    
                break
