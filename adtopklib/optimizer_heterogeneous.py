...
class _DistributedOptimizer(torch.optim.Optimizer):
    ...
    def fast_allgather_receive(self, result, ctx, name, tensor):
        ...
        from adtopk_lib.heterogeneous.compensation import staleness_gradient_compensation
        return staleness_gradient_compensation(tensor_decompressed / self.world_size,self.memory,name)
